...
public class ListaDupla<T> {
    ...
    private DNode<T> inicio;
    private DNode<T> ultimo;

    private int tamanho = 0;

        //ADICIONAR UM VALOR NO FINAL DA LISTA
        public void adicionar(T elemento) {
            DNode<T> celula = new DNode<T>(elemento);
        ...
        //LIMPAR DA LISTA
        public void limpar() {
            for (DNode<T> atual = this.inicio; atual != null;) { //AJUDA NO GERENCIAMENTO DE MEMORIA

                DNode<T> aux = atual.getProximo();
        ...
        public void imprimir() {
            if (this.tamanho == 0) //SE A LISTA FOR VAZIA
            {
                ...
                DNode<T> atual = this.inicio; //POSICIAO ATUAL DO VETOR COMEÇANDO NA POSICAO INICIAL
